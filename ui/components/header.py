...
def render_top_navbar() -> None:
    ...
    col_brand, col_nav = st.columns([4.2, 5.8], vertical_alignment="center")
    ...
    with col_brand:
        st.markdown(
            ...
            '<span class="brand-badge">SaaS Intelligence</span>'
            '</div>'
            '</div>',
    ...
    with col_nav:
        c1, c2, c3 = st.columns([1, 1, 1.4], vertical_alignment="center")
